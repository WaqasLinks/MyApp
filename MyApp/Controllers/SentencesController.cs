...
namespace MyApp.Controllers
{
    ...
    {
        private readonly reportgenContext _context;

        public SentencesController(reportgenContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,SentenceText")] Sentence sentence)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SentenceText")] Sentence sentence)
        {
            if (id != sentence.Id)
            {
                return NotFound();
